...
func (*Predicate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
// Client API for Journaleux service
...
func (c *journaleuxClient) Tail(ctx context.Context, in *Predicate, opts ...grpc.CallOption) (Journaleux_TailClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Journaleux_serviceDesc.Streams[0], c.cc, "/rpc.Journaleux/Tail", opts...)
	if err != nil {
		return nil, err
	}
...
// Server API for Journaleux service
...
func init() { proto.RegisterFile("journaleux.proto", fileDescriptor0) }
